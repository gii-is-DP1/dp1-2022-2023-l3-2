...
|--------------------------|---|
|The Main Class | [DwarfApplication](https://github.com/gii-is-DP1/spring-petclinic/blob/master/src/main/java/org/springframework/samples/petclinic/DwarfApplication.java) |
